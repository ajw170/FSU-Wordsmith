/*
    ...
    In this implementation the cases (data_ == nullptr) and (size_ == 0) are
...
namespace fsu
{
  ...
  String::String(const char* Cptr)  :  data_(nullptr), size_(0)  
  {
    // Debug d("String constructor 2");
    Wrap(Cptr);
  }

  String::String (size_t size, char fill) : data_(nullptr), size_(0)
  {
